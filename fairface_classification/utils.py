...
def create_models_dir():
    """
    Creates the directory structure for saving models, including the parent directory if it does not exist.
    ...
    check_dir = Path('../models/checkpoint')
    ...
    if not best_dir.exists():
        # If the best model directory does not exist, create it.
        best_dir.mkdir()
